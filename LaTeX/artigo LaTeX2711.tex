...
\noi e-mail: ecacarva@gmail.com and luc.and1973@gmail.com %please use institutional emails
...
\begin{comment}
AQUI OU CITARIA NAS REFERENCIAS, FICA A SEU CRITERIO DEPENDENDO DE COMO VOCE ESTEJA LIDANDO COM A COISA NAS OUTRAS PARTES DESSE MESMO ARTIGO).
\end{comment} 
...
\begin{comment}
LUCIANO, AQUI EU COLOCARIA A REFERENCIA PRO NOSSO SOP DE DELPHI
\end{comment}
...
\begin{comment}
TROCARIA A CITACAO PELO GITHUB
...
\begin{comment}
RETIREI VARIAS COISAS DAQUI, DEPOIS POR FAVOR DELETE AS REFERENCIAS CORRESPONDENTES
\end{comment}
...
\begin{comment}
NOS TEMOS UM APPENDIX E UMA SECAO 7? LUCIANO, ACHO QUE VALERIA A PENA LER O ARTIGO INTEIRO PRA VER SE NAO EXISTEM INCONSISTENCIAS OU OUTRAS COISAS QUE ESTEJAM CITADAS E NAO MAIS FACAM PARTE DO ARTIGO, INCLUINDO REFERENCIAS A ABM
...
\begin{comment}
http://goo.gl/AHZ4 POR FAVOR INSIRA A REFERENCIA -- COLOQUEI O LINK SO COMO REFERENCIA
\end{comment}
...
\begin{comment}
LUCIANO, POR FAVOR VEJA QUE TODAS AS ABREVIACOES ESTEJAM CORRETAS, OU SEJA, UMA VEZ QUE UMA ABREVIACAO SEJA DECLARADA, A PARTIR DALI SO A ABREVIACAO E USADA E NAO MAIS O NOME INTEIRO.
\end{comment}
